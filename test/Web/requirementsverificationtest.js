...
describe('Requirements page verification', async () => {
    it('Tc01 Validate all requirements created are displayed', async () => {
    ...
    it('Tc02 Verify requirements score is a display', async () => {
        await browser.back()
        await (await requirementsverificationpage.requirements).click()
    ...
    it('Tc03 Verify requirements name is editable', async () => {
        await browser.back()
        await (await requirementsverificationpage.requirements).click()
    ...
    it('Tc05 Verify all static contents are display', async () => {
        await browser.back()
        await (await requirementsverificationpage.requirements).click()
    ...
    it('Tc06 Verify payments status of requirements are display', async () => {
        await browser.back()
        await (await requirementsverificationpage.requirements).click()
