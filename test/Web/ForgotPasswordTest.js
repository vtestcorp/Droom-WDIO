...
describe("Forgot Password", () => {
    it("TC_01 Verify The Functionality Of Log In With Old Password In Forgot Password Page", async () => {
        ...
        await (await ForgotPasswordPage.emailTB).setValue("vikasy898@gmail.com")
        ...
        await (await ForgotPasswordPage.loginViaPasswordBtn).waitForDisplayed({ timeout: 2000 })
        await (await ForgotPasswordPage.loginViaPasswordBtn).click()
